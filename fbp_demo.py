...
sino = mpw.read_sinogram_segments(run_dir,cfg, scatter=True)
sino = rb.ssrb(sino, cfg) # (nplanes, nangles, nradials)
plot3Dimage(sino, "sinogram_na.png", "Simulated (MC) sinogram (SSRB; scatter only)")
